...
if not urls:
    ...
    for url in urls:
        ...
        time.sleep(2)  # Respectful delay to avoid overloading servers
        try:
            ...
            # Check conditions
            if "2024" in url or (modified_date and modified_date.year >= 2024):
                valid_pdfs.append({"url": url, "last_modified": last_modified or "Not Available"})
            else:
                invalid_pdfs.append({"url": url, "last_modified": last_modified or "Not Available"})
