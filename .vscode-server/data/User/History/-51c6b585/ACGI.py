...
def setup_vectorstore(products):
    ...
    # Make sure each product has a description field to use as page_content
    doc_chunks = [{"page_content": product.get("description", "No description available")} for product in products]
