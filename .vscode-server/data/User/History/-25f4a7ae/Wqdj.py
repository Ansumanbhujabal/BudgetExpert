...
from llama_index import SimpleDirectoryReader, ServiceContext, VectorStoreIndex, Document, QueryEngine
...
# Initialize Pinecone
pinecone.init(api_key="pcsk_3ftM6d_C4NpuCttSsZXQbgDPffRpMcBRQoy8jLMUWAJYKHcakq4kzJKik3t6SakQ25VX5V", environment="YOUR_PINECONE_ENV")
