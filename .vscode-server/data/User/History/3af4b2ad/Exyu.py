...
pinecone_index = pinecone.Index("pdf-text-index")

UPLOAD_FOLDER = './uploads/'
pdf_texts = {}  # For storing filenames and their extracted texts for the session
...
async def upload_pdf(file: UploadFile = File(...), background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(process_pdf, file_location, file.filename)
